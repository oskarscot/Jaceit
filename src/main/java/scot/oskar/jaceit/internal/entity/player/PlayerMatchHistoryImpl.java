...
import scot.oskar.jaceit.api.entity.player.PlayerMatchHistory;

import java.util.List;
import java.util.Map;

public class PlayerMatchHistoryImpl implements PlayerMatchHistory {
    ...
    public static class MatchImpl implements Match {
        ...
        public static class ResultsImpl implements Results {
            ...
            public static class ScoreImpl implements Score {
